...
print(words)
first_idx = words.index('because')
print('first index : ', first_idx)
#last index
reversed_words = words[::-1]
print('reversed_words : ', reversed_words)
last_reverse_indx = reversed_words.index('because')
print('last reversed words : ', last_reverse_indx)
last_idx = len(words) - last_reverse_indx - 1
print('last index : ', last_idx)
print(words[first_idx])
print(words[last_idx])
